package project.controllers.customers;

import project.domains.Customer;
import project.dto.request.CustomerRequest;
import project.dto.response.CustomerResponse;
import project.facade.Hse;
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerResponse> createCustomer(
        ...
        hseFacade.addCustomer(request.getName(), request.getLegPower(),
                request.getHandPower(), request.getIq());
    ...
    public ResponseEntity<CustomerResponse> updateCustomer(
            ...
            @Valid @RequestBody CustomerRequest request) {
        Customer updatedCustomer = Customer.builder().name(name)
                .legPower(request.getLegPower())
                .handPower(request.getHandPower()).iq(request.getIq()).build();
    ...
    private CustomerResponse convertToResponse(Customer customer) {
        return new CustomerResponse(customer.getName(), customer.getLegPower(),
                customer.getHandPower(), customer.getIq(),
                customer.getCar() != null ? customer.getCar().getVin() : null,
                customer.getCatamaran() != null
                        ? customer.getCatamaran().getVin()
                        : null);
    }
}
