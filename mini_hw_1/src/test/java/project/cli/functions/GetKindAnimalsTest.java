...
@SpringBootTest
public class GetKindAnimalsTest {
    @Mock
    AnimalStorage animals;
    @InjectMocks
    GetKindAnimals getKindAnimals;
    @Mock
    IAnimal animal;
    ...
    public void testExecuteWithoutAnimals() {
        when(animals.getKindAnimals()).thenReturn(new IAnimal[] {});
        getKindAnimals.execute();
    }

    @Test
    @DisplayName("Test execute method with animals")
    public void testExecuteWithAnimals() {
        when(animals.getKindAnimals())
                .thenReturn(new IAnimal[] { animal, animal });
        getKindAnimals.execute();
    }
}
