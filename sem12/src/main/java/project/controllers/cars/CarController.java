package project.controllers.cars;
...
import project.dto.request.CarRequest;
...
public class CarController {
    ...
    public ResponseEntity<Car> getCarByVin(@PathVariable int vin) {
        return carService.findByVin(vin).map(ResponseEntity::ok)
    ...
    public ResponseEntity<Car> updateCar(@PathVariable int vin,
        ...
        return carService.findByVin(vin).map(existingCar -> {
