package project.services.catamarans;
...
import project.interfaces.catamarans.CatamaranProvider;
import java.util.List;
import java.util.Objects;
import java.util.Optional;
import project.repositories.CatamaranRepository;
...
public class HseCatamaranService implements CatamaranProvider {
    ...
    public Catamaran takeCatamaran(Customer customer) {
        ...
        var filteredCatamarans = catamaranRepository.findAll().stream()
     ...
     */
    public <T> Catamaran addCatamaran(CatamaranFactory<T> catamaranFactory,
            T catamaranParams) {
        return catamaranRepository
                .save(catamaranFactory.create(catamaranParams));
    }
    ...
    public List<Catamaran> getCatamaransWithFiltration(String engineType,
            Integer vin) {
        return catamaranRepository
                .findCatamaransByEngineTypeAndVinGreaterThan(engineType, vin);
    }
